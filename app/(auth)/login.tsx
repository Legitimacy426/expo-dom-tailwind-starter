      ...
      <div className="w-full max-w-md space-y-6 bg-white p-8 rounded-lg shadow-sm border">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="email" type="email" placeholder="contact@bundui.com" className="h-10" />
          </div>
          ...
          <Button className="w-full h-10 bg-black hover:bg-black/90 text-white">Login</Button>
        </div>
        ...
        <div className="space-y-3">
          <Button variant="outline" className="w-full h-10 bg-white text-foreground border-gray-200 hover:bg-gray-50">
