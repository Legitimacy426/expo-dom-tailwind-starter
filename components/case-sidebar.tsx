...
interface CaseSidebarProps {
  config?: CaseSidebarConfig
}

export function CaseSidebar({ config }: CaseSidebarProps) {
  ...
  const sidebarConfig = {
    title: config?.title || context?.title || "Case Management",
    description: config?.description || context?.description || "Active case management and care planning",
